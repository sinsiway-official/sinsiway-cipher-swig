...
char* PcAPI_encrypt_ruby(int api_sid, long long enc_col_id, char* src, int src_len);
char* PcAPI_decrypt_ruby(int api_sid, long long enc_col_id, char* src, int src_len);
char* PcAPI_encrypt_name_ruby(int api_sid, char* enc_col_name, char* src, int src_len);
char* PcAPI_decrypt_name_ruby(int api_sid, char* enc_col_name, char* src, int src_len);
