...
static zend_function_entry libpcphp_functions[] = {
 SWIG_ZEND_NAMED_FE(pcapi_initialize,_wrap_PcAPI_initialize,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(pcapi_getsession,_wrap_PcAPI_getSession,swig_arginfo_0)
 SWIG_ZEND_NAMED_FE(pcapi_encrypt,_wrap_PcAPI_encrypt,swig_arginfo_000000)
 SWIG_ZEND_NAMED_FE(pcapi_decrypt,_wrap_PcAPI_decrypt,swig_arginfo_000000)
 SWIG_ZEND_NAMED_FE(pcapi_encrypt_name,_wrap_PcAPI_encrypt_name,swig_arginfo_000000)
 SWIG_ZEND_NAMED_FE(pcapi_decrypt_name,_wrap_PcAPI_decrypt_name,swig_arginfo_000000)
 SWIG_ZEND_NAMED_FE(pcapi_enc_id,_wrap_PcAPI_enc_id,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(pcapi_dec_id,_wrap_PcAPI_dec_id,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(pcapi_enc_nm,_wrap_PcAPI_enc_nm,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(pcapi_dec_nm,_wrap_PcAPI_dec_nm,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(pcapi_cryptfile,_wrap_PcAPI_cryptFile,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(pcapi_isencrypted,_wrap_PcAPI_isEncrypted,swig_arginfo_0)
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(libpcphp, libpcphp_init_globals, NULL);
